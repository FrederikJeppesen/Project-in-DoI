...
Step by step guide
    ...
    5. How to sign up as a Customer:
        ...
        5.4 DO NOTE: 
            When writing a 'Zone' choose 1 or 3. 
            When writing a 'Base' choose 'Herlev' or 'Virum'.  
            Also notice that 'Herlev' is in zone 1 and 'Virum' is in zone 3. So when you sign up remember to write write 1 in 'Zone' if you write 'Herlev' in Base. Write 3 in 'Zone' if you write 'Virum' in Base.
            Our thought is that the Zones should consist of different Bases. You're able to add more Bases to the existing Zones (or new Zones).
            But if you write other Bases or Zones than the above metioned you will not be able to order any food since our database only have Restaurants with the above mentioned Zones and Bases.
